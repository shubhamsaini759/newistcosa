      ...
      {Profession === "Student" ? (
        <>
          <div className={Styles.secondRow}>
            <SimpleInputs sw="22%" aw="68%" label="College/University" value={college} changeHandler={collegeHandler}  />
            <SimpleInputs sw="22%" aw="68%" label="Quaification" value={quali} changeHandler={qualiHandler}  />
          </div>
          <div className={Styles.thirdRow}>
            <TagInput sw="27%" nsw="68%" padd="5%" label="Skills" value={skill} changeHandler={skillHandler} />
            <DateInput
              sw="27%"
              rw="68%"
              padd="5%"
        ...
        <>
          <div className={Styles.secondRow}>
            <SimpleInputs sw="25%" aw="65%" label="Job Designation" value={designation} changeHandler={desigHandler} />
            <SimpleInputs sw="25%" aw="65%" label="Recent Company" value={recent} changeHandler={recentHandler} />
          </div>
          <div className={Styles.thirdRow}>
            <StartDateInput label="From date" sw="30%" padd="4.5%" aw="65%" value={start} changeHandler={startHandler} />
            <StartDateInput label="To date" padd="4.5%" sw="30%" aw="65%" value={to} changeHandler={toHandler} />
          </div>
