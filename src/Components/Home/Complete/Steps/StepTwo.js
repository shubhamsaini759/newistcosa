...

      {
        ...
        <>
          ...
          <div className={Styles.thirdRow}>
            ...
            <DateInput sw='27%' rw='68%' padd='5%' label='Start & Completion Year' />
          </div>
        </>
        : 
        flag === 'Government Sector'?
          <>
            <div className={Styles.secondRow}>
              <AutoInputs sw='19%' aw='71%'  label='Job Designation' />
              <AutoInputs sw='19%' aw='71%'  label='Recent Company' />
            </div>
            <div className={Styles.thirdRow}>
            ...
            <div className={Styles.fourthRow}>
              <TextAreaInput  label='Describe Your Work Profile' tw='97%' sw='20%'   />
            </div>
          </> 
        :
        ''
