...
const EditIconModal = (props) => {
    ...
    const { data : addCompany , mutateAsync : compDetails } = useMutation('AddCompany',AddCompany)
  ...
  return (
    <Form layout='vertical' form={form} initialValues={val}  >
        ...
        <div className={Styles.fifthRow}>
            <AutoInputs label='Country' name='Country' list={countryList} handler={countryHandler} />
            <AutoInputs label='State' name='State' list={stateList} handler={stateHandler} />
            <AutoInputs label='City' name='City' list={cityList} handler={cityHandler} />
        </div>
