    ...
    <>
        <div className={Styles.Bottom}>
            ...
            <div className={Styles.myself}>
             ...
             {
                props?.data?.ProfessionalInformation.map((x)=> 
                    <div className={Styles.expDetails}>
                        <div className={Styles.expinfo}>
                             ...
                             <div>
                                <PortraitIcon fontSize='small' style={{ marginRight : 10}} /><span>{x.Designation}</span>
                             </div>
                             <div>
                                <BusinessCenterIcon fontSize='small' style={{ marginRight : 10}} /><span>Profession : {x.Profession}</span>
                             </div>
                             <div>
                                <CalendarMonthIcon fontSize='small' style={{ marginRight : 10}} /><span>{new Date(x.FromDate).toDateString().slice(3,15)} - {x.ToDate? new Date(x.ToDate).toDateString().slice(3,15) : ""}</span>
                             </div>
                        </div>
